...
export const routes: Routes = [
  ...
  { path: 'private/employee-panel/book-return', component: PageBookLendComponent, canActivate: [AuthGuard, EmployeeAuthGuard], data: {isLend: false}},
  { path: 'private/employee-panel/book-lend', component: PageBookLendComponent, canActivate: [AuthGuard, EmployeeAuthGuard], data: {isLend: true}},
